...
class CustomSpriteInfo extends React.Component {
            ...
            <Box className={styles.spriteInfo}>
                ...
                <div className={styles.compactRow}>
                    <div className={styles.compactGroup}>
                        ...
                        >
                            {message => (
                                <span className={styles.compactLabel}>{message}</span>
                            )}
                        </FormattedMessage>
                        <BufferedInput
                            small
                    ...
                    <div className={styles.compactGroup}>
                        ...
                        <BufferedInput
                            ...
                            tabIndex="0"
                            type="text"
                            value={this.props.disabled ? '' : Math.round(this.props.direction)}
...
export default injectIntl(CustomSpriteInfo);

...
PaintEditorComponent.propTypes = {
    ...
    onSwitchToBitmap: PropTypes.func,
    onSwitchToVector: PropTypes.func,
    ...
    // Color props (made optional since they're not provided in mapStateToProps)
    fillColor: PropTypes.string,
    fillColor2: PropTypes.string,
    fillColorModalVisible: PropTypes.bool,
    fillGradientType: PropTypes.string,
    fillDisabled: PropTypes.bool,
    onChangeFillColor: PropTypes.func,
    onChangeFillGradientType: PropTypes.func,
    onOpenFillColor: PropTypes.func,
    onCloseFillColor: PropTypes.func,
    strokeColor: PropTypes.string,
    strokeColor2: PropTypes.string,
    strokeColorModalVisible: PropTypes.bool,
    strokeGradientType: PropTypes.string,
    strokeDisabled: PropTypes.bool,
    onChangeStrokeColor: PropTypes.func,
    onChangeStrokeGradientType: PropTypes.func,
    onOpenStrokeColor: PropTypes.func,
    onCloseStrokeColor: PropTypes.func,
    shouldShowGradientTools: PropTypes.bool,

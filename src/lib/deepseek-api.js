...
// 在浏览器环境中，我们需要使用默认的API密钥
// 在生产环境中，应该通过构建时的环境变量或配置文件来设置
const API_KEY = (typeof process !== 'undefined' && process.env && process.env.DEEPSEEK_API_KEY) || 'sk-7a9202f7b723433991b772e4cde4c7e9';
